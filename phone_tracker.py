...
def main():
    ...
    if choice == "1":
        ...
        if result1 and "error" not in result1:
            name = result1.get("Name") or result1.get("name", "N/A")
            cnic = result1.get("CNIC") or result1.get("cnic", "N/A")
            addr = result1.get("ADDRESS") or result1.get("address", "N/A")
            mob = result1.get("Mobile") or result1.get("mobile", "N/A")
